                ...
                <Link key={city.slug} href={`/cities/${city.slug}`}>
                  <div className="relative h-[450px] rounded-[2.5rem] overflow-hidden group cursor-pointer shadow-xl">
                    ...
                    <div className="absolute inset-0 p-8 flex flex-col justify-end">
                      ...
                      <Button className="w-full h-12 rounded-xl bg-primary hover:bg-white hover:text-primary text-white font-black text-[9px] tracking-tighter transition-all px-1 uppercase leading-none">
                        VODIČ KROZ GRAD
                      </Button>
                    </div>
                  </div>
