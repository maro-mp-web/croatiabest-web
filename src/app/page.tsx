  ...
  return (
    <div className="min-h-screen flex flex-col bg-background overflow-x-hidden">
      ...
      <main className="flex-1">
        ...
        {/* CITY GUIDES */}
        <section className="py-24 bg-white relative z-30 shadow-2xl rounded-t-[3rem] -mt-16">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-5xl md:text-7xl font-headline font-black italic tracking-tighter text-foreground">Najljepši gradovi</h2>
            </div>
                ...
                <Link key={city.slug} href={`/cities/${city.slug}`}>
                  <div className="relative h-[350px] rounded-[2.5rem] overflow-hidden group cursor-pointer shadow-xl">
                    ...
                    <div className="absolute inset-0 p-6 flex flex-col justify-end">
                      <p className="text-[10px] font-black uppercase text-primary mb-1 tracking-widest">{city.region}</p>
                      <h4 className="text-3xl font-black italic mb-4 text-white">{city.name}</h4>
                      <Button className="w-full h-10 rounded-xl bg-primary hover:bg-white hover:text-primary text-white font-black text-[8px] tracking-[-0.05em] transition-all px-1 uppercase leading-none">
                        VODIČ KROZ GRAD
                      </Button>
                    </div>
                  </div>
        ...
        {/* CATEGORIES SECTION */}
        <section className="py-20 bg-secondary/5 relative z-30">
          <div className="container mx-auto px-6">
