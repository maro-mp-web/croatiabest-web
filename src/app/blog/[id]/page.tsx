...
export default function ArticleDetailPage() {
  ...
  const article = MOCK_ARTICLES.find(a => a.id === params.id) || MOCK_ARTICLES[0];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-12">
              <div className="bg-white/80 backdrop-blur-xl rounded-[3rem] p-8 md:p-16 shadow-2xl border border-white/40">
                ...
                <div className="prose prose-xl max-w-none font-body leading-loose text-foreground/90 whitespace-pre-wrap">
                  {article.content}
                </div>
