...
import { ISLANDS } from '@/app/lib/constants';
                ...
                <div className="space-y-6">
                  ...
                  {popular.map(l => (
                    <Link key={l.id} href={`/listing/${l.id}`}>
                      <Card className="border-none shadow-lg rounded-2xl bg-secondary/5 p-4 hover:scale-[1.02] transition-transform cursor-pointer">
